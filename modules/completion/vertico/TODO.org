...
They are currently set to =C-;=, =<leader> a= and =<menu>=. The motivation for
this is as follows:
*** =C-;=
...
- ~embark~ like most packages in the vertico cinematic universe can be
  ...
  on-buffer actions.
*** =<menu>=
Quote from ~embark~'s README:
#+begin_quote
This package provides a sort of right-click contextual menu for Emacs
#+end_quote

In other applications, =<menu>= almost always triggers the list of contextual
actions at point, which remarkably fits ~embark~'s popup commands.
